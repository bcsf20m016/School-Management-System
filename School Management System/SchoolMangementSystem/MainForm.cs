...
namespace SchoolMangementSystem
{
    public partial class MainForm : Form
    {
        ...
        private void button3_Click_1(object sender, EventArgs e) //For logout
        {
        ...
        private void button1_Click(object sender, EventArgs e) //For dashboard
        {
        ...
        private void AddStudent_btn_Click(object sender, EventArgs e) //For Students
        {
            dashboardForm1.Visible = false;
